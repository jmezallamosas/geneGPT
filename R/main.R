# Function
#' Gene Fuction Anotation Query
#'
#' @param genes Vector of genes whose function you want to query
#'
#' @return List of functions for each gene
#' @export
#'
#' @examples
#'
...
#' Add OPENAI API KEY to .Renviron
#'
#' @param key_value
#' @param force
#'
